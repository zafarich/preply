export default {
    ...
    premium_info:
        'Возможность пройти все тесты на 6 месяцев. (*Кроме Prime тестов)',
    prime_info:
        'Возможность приобрести одноразовые Prime (mock и блок) тесты. Одна подписка = один раз прохождение теста.',
